import { data as data_pt_BR } from '../../assets/languages/categories/pt_BR';
import { data as data_en_US } from '../../assets/languages/categories/en_US';

export default class CategoriesLanguages {
